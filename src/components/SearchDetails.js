...
const SearchDetails = () => {
    ...
    const url = location.state.species.url;
    const [description, setDescription] = useState("");
    const [nameGER, setNameGer] = useState("");
    ...
    return (
        <div className='details-container'>
            ...
            <img className='imgPokemon_details' src={location.state.sprites.other.dream_world.front_default} alt='image of pokemon' />
            </div>
            <h2 className='details_name' >{location.state.name}</h2>
            <div className='type'>
            ...
            <div className='info'>
            <div className='stats'>
            <p>HP: </p><p>{location.state.stats[0].base_stat}</p>
            </div>
            <div className='stats'>
            <p>Attack: </p><p>{location.state.stats[1].base_stat}</p>
            </div>
            <div className='stats'>
            <p>Defense: </p><p>{location.state.stats[2].base_stat}</p>
            </div>
            <div className='stats'>
            <p>Speed: </p><p>{location.state.stats[5].base_stat}</p>
            </div>
            </div>

...
const EmptyComponent = () => {
    return (
        <div className='details-container hintergrund_patter'>
            ...
            <div className='info shadow_deck'>
